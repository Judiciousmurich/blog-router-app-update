function Footer() {
    ...
    return (
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "120vh",  paddingTop: "20px", background: "white", color: "darkgray", fontSize: "12px" ,marginLeft:"135px"}}>
