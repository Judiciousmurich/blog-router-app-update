function Footer() {
    ...
    return (
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "100%",  paddingTop: "20px", background: "white", color: "darkgray", fontSize: "12px" ,marginLeft:"135px"}}>
